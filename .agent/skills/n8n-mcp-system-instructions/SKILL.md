---
name: n8n-mcp-system-instructions
description: Core system instructions and best practices for building n8n workflows using the n8n-mcp server tools.
---

# n8n-mcp System Instructions
